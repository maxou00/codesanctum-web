        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-auto max-w-full px-4 xl:mr-12">
              <Link
                href="/"
                className={`header-logo flex flex-row items-center justify-center gap-2 ${
              ...
              >
                <img
                  ...
                  alt="logo"
                  className="h-[68px] w-[68px] dark:hidden"
                />
                <img
                  src="/images/logo/logo-2.svg"
                  alt="logo"
                  className="hidden h-[68px] w-[68px] dark:block"
                />
                <h1 className="font-heading text-xl text-dark dark:text-white">
                  CodeSanctum
                </h1>
              </Link>
            </div>
